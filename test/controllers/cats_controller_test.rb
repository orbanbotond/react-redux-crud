...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { breed: @cat.breed, name: @cat.name, temperament: @cat.temperament, weight: @cat.weight } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { breed: @cat.breed, name: @cat.name, temperament: @cat.temperament, weight: @cat.weight } }
